...
const Contact = () => {
    ...
    const handleSubmit=async()=>{
        ...
        if(valid){
            ...
            toast.success('Submitted Sucessfully!', {duration:3000});
        }
        else{
    ...
    return <div className="px-16 md-mx:px-8 sm-mx:px-4 mx-20 lg-mx:mx-10 md-mx:mx-0 mt-20  my-10  font-mono" id="Contact">
    ...
    <div data-aos="flip-left" data-aos-duration="800" className="w-[60%] lg-mx:w-full shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-primaryColor p-8 rounded-3xl sm-mx:p-4">
