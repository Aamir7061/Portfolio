...
const SkillCard =(props:any)=>{
    return <div data-aos="zoom-in-up" data-aos-duration="800" data-aos-easing="ease-in-sine" className="w-[45%] mt-10 shadow-[0_0_10px_0_#64FFDA50] rounded-3xl border border-primaryColor p-6 bs-mx:p-3 sm-mx:w-full ">
